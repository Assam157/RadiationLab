...
export function startFaraday(canvas) {
  ...
  function updatePhysics(dt) {
    ...
    if (Math.abs(m.v) < params.movingThreshold) {
  ...
  /* ================= DRAW ================= */
  /* ⚠️ ALL your drawBackground, drawCircuit,
        drawCoil, drawAmmeter, drawBulb,
        drawMagnet, drawFieldLines,
        drawFluxArrow, drawArrowHead
     STAY EXACTLY THE SAME
     — NO CHANGES REQUIRED
  */

  // ⬇️ KEEP YOUR DRAW FUNCTIONS HERE (UNCHANGED)
...
function drawUIOverlay() {
  ...
  function keyDown(e) {
    if (e.code === "ArrowLeft") state.magnet.v = -params.speed;
    if (e.code === "ArrowRight") state.magnet.v = params.speed;
  }
